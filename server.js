...
${isMuted ? `🔇 В муте: ещё ${muteRemaining} мин` : "🔊 Не в муте"}
    ...
    // ========== ГОЛОСОВОЙ ЧАТ (FIX: теперь слышно всех) ==========
    socket.on("join-voice-channel", (channelName) => {
        ...
        // Отправляем существующих участников новому
